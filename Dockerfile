...
COPY DmfAXML2RDF.ipynb validate.ipynb annex00.nq annex10.nq fullQuadStore.nq.gz /home/jovyan/work
...
RUN wget -O package/apache-jena-fuseki.tar.gz https://dlcdn.apache.org/jena/binaries/apache-jena-fuseki-4.10.0.tar.gz && \
    tar -xzf package/apache-jena-fuseki.tar.gz && \
    mv apache-jena-fuseki-* package/apache-jena-fuseki && \
    cp -r package/apache-jena-fuseki package/annex10 && \
